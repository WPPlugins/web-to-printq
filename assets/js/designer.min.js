...
o.attr({id:"c1"}),e(a.tempCanvas).append(o),tempCanvas=new fabric.Canvas("c1",{width:900,height:500}),themePageContent=defaultThemeProduct,canvas.on("mouse:up",function(e){t.runHooks("updateIframe")}),canvas.allowTouchScrolling=!1,t.bindEvents(a),t.verifytd(),e.editorCustomPagination.init({page:1}),setTimeout(function(){t.loadCanvas(themePageContent[0]),setTimeout(function(){canvas.renderAll()},500)},0),t.checkEvents(),t.observeDrawTextBox(),e(a.goBackEditor).click(function(e){return function(){t.goBack()}}(a)),e(a.saveProjectAdminButton).click(function(e){return function(){t.adminSaveProject()}}(a))}})}(window.jQuery),!function(e){var t=e.printqSnaptoObject={}
...
"undefined"!=typeof window.parent.FORM_KEY&&(a.form_key=window.parent.FORM_KEY),e.extend(t,{defaults:{url:null,data:a,dataType:"JSON",onComplete:function(e){},onFail:function(e){},mask:"#loading-mask"},_O:function(a){var n=e.extend(!0,{},t.defaults)
...
n.url!=getUserPhotosUrl&&n.url!=baseUrl+"openeditor/theme/theme"||(i=!0),"undefined"==typeof n.data.nonce&&(n.data.pqd_nonce=pqd_nonce),e(n.mask).prinqLoading("start",o,{cancelLoading:i}),e.ajax({type:"POST",url:n.url,dataType:n.dataType,headers:{"X-CSRF-TOKEN":e('meta[name="csrf-token"]').attr("content")},data:n.data}).done(function(t,a){return function(n){a.onComplete(n),e(a.mask).prinqLoading("stop",t)}}(o,n)).fail(function(t,a){return function(n){a.onFail(n),e(a.mask).prinqLoading("stop",t)}}(o,n))},getRequest:function(a){var n=t._O(a)
...
if(y>=0&&y<r&&_>=0&&_<i){var H=4*(y*i+_),S=t[w*a+I]
m+=o[H]*S,b+=o[H+1]*S,k+=o[H+2]*S,C+=o[H+3]*S}}d[v]=m,d[v+1]=b,d[v+2]=k,d[v+3]=C+u*(255-C)}return l},slicerRGBA:function(e,a,n){for(var o=t.getDefaults(),i=(e.height,e.width),r=i*a*o.t,s=e.data.length,c=0,l=r,d=[];s>l-r>0;){var u=e.data.subarray(c,l)
...
break
case"zoomIn":var o=this.getElement("zoom_text_group")
this.runHooks("zoomIn",o)
break
case"zoomOut":var o=this.getElement("zoom_text_group")
this.runHooks("zoomOut",o)
break
case"back-shapes-category":this.changeShapeFrame("categories")}}})
var d=this.getElement("zoom_text_group")
this.runHooks("mouseZoomInit",d),this.selectDefaultLayout(),this.init()},changeShapeFrame:function(e){this.element.data("offset",0)
var t=this.getElement("shapesGallery")
t&&(t.removeClass(this.shapesFrames),t.addClass(e))},connectHooks:function(){this.addGlobalHook("makeBackgroundImageSelected",this.makeBackgroundImageSelected,this),this.addGlobalHook("loadShape",this.loadShape,this),this.addGlobalHook("loadLayout",this.loadLayout,this),this.addGlobalHook("makeActualLayoutSelected",this.makeActualLayoutSelected,this),this.addGlobalHook("loadShapeMobile",this.loadShapeMobile,this)},init:function(){this.blurThis(),this.observe()},observe:function(){canvas.on("before:mouse:down",function(e){return function(t){(e.drawSquare||e.drawCircle)&&(canvas.selection=!1)}}(this)),canvas.on("mouse:down",function(e){return function(t){if(e.drawSquare){var a=canvas.getPointer(t.e)
...
n.tooltip({items:"div,li",show:!1,hide:!1,track:!0,content:function(){var t=e(this),a=e(".tooltip"),n=t.data("tooltip")
