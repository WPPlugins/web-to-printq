...
var i=this._calculateCurrentDimensions(!0),a=i.x,n=i.y,s=-(a/2),o=-(n/2),r=(this.padding/this.scaleX,this.padding/this.scaleY,this.cornerSize/2),c=(this.transparentCorners?"strokeRect":"fillRect",this.isScaling?this.cornerSize:this.cornerSize/10+13)
if("undefined"!=typeof e.viewport&&(e.viewport[0]<1||e.viewport[3]<1)){var l=e.viewport[0]>e.viewport[3]?e.viewport[3]:e.viewport[0]
c=this.cornerSize*l/1.7}return t.save(),t.lineWidth=1,fabric.isInRotateMode?this.hasRotatingPoint&&t.drawImage(fabric.rotateImage,s+a/2-r,o-this.rotatingPointOffset-r,this.cornerSize,this.cornerSize):(t.globalAlpha=this.isMoving?this.borderOpacityWhenMoving:1,t.strokeStyle=t.fillStyle=this.cornerColor,this.isScaling&&"bottom"==e.originY&&"right"==e.originX||!this.isScaling?this._drawRoundControl("tl",t,"arc",s,o,c,!1):this._drawRoundControl("tl",t,"arc",s,o,3,!0),this.isScaling&&"bottom"==e.originY&&"left"==e.originX||!this.isScaling?this._drawRoundControl("tr",t,"arc",s+a,o,c,!1):this._drawRoundControl("tr",t,"arc",s+a,o,3,!0),this.isScaling&&"top"==e.originY&&"right"==e.originX||!this.isScaling?this._drawRoundControl("bl",t,"arc",s,o+n,c,!1):this._drawRoundControl("bl",t,"arc",s,o+n,3,!0),this.isScaling&&"top"==e.originY&&"left"==e.originX||!this.isScaling?this._drawRoundControl("br",t,"arc",s+a,o+n,c,!1):this._drawRoundControl("br",t,"arc",s+a,o+n,3,!0),this.get("lockUniScaling")||((this.isScaling&&"bottom"==e.originY&&"center"==e.originX||!this.isScaling)&&a>150?this._drawRoundControl("mt",t,"arc",s+a/2,o,c,!1):this._drawRoundControl("mt",t,"arc",s+a/2,o,3,!0),(this.isScaling&&"top"==e.originY&&"center"==e.originX||!this.isScaling)&&a>150?this._drawRoundControl("mb",t,"arc",s+a/2,o+n,c,!1):this._drawRoundControl("mb",t,"arc",s+a/2,o+n,3,!0),(this.isScaling&&"center"==e.originY&&"left"==e.originX||!this.isScaling)&&(a>150||"textbox"==this.type)?this._drawRoundControl("mr",t,"arc",s+a,o+n/2,c,!1):this._drawRoundControl("mr",t,"arc",s+a,o+n/2,3,!0),(this.isScaling&&"center"==e.originY&&"right"==e.originX||!this.isScaling)&&(a>150||"textbox"==this.type)?this._drawRoundControl("ml",t,"arc",s,o+n/2,c,!1):this._drawRoundControl("ml",t,"arc",s,o+n/2,3,!0))),t.restore(),this},drawBorders:function(t){if(!this.hasBorders)return this
...
var e,i,a=t.x,n=t.y
for(var s in this.oCoords)if(this.isControlVisible(s)&&("mtr"!==s||this.hasRotatingPoint)&&("mtr"!==s||fabric.isInRotateMode)&&(!this.get("lockUniScaling")||"mt"!==s&&"mr"!==s&&"mb"!==s&&"ml"!==s)&&(!fabric.isInRotateMode||"bl"!==s&&"br"!==s&&"mb"!==s&&"ml"!==s&&"mr"!==s&&"mt"!==s&&"tl"!==s&&"tr"!==s)&&(i=this._getImageLines(this.oCoords[s].corner),e=this._findCrossPoints({x:a,y:n},i),0!==e&&e%2===1))return this.__corner=s,s
return!1},_drawRoundControl:function(t,e,i,a,n,s,o){if(this.isControlVisible(t)){this.cornerSize
isVML()||this.transparentCorners,e.beginPath(),e.fillStyle=fabric.ColorBorders,e[i](a,n,s,0,2*Math.PI,!1),e.fill(),e.closePath(),o||(e.beginPath(),e.fillStyle="#ffffff",e[i](a,n,s/2,0,2*Math.PI,!1),e.fill(),e.closePath())}}},extendObjectPrototypePC={borderOpacityWhenMoving:.5,borderScaleFactor:1,borderColor:"rgba(153, 209, 34, 0.75)",cornerColor:"rgba(153, 209, 34, 0.75)",cornerSize:10,drawControls:function(t,e){if(!this.hasControls)return this
var i=this._calculateCurrentDimensions(!0),a=i.x,n=i.y,s=-(a/2),o=-(n/2),r=this.cornerSize/2,c=this.transparentCorners?"strokeRect":"fillRect"
return t.save(),t.lineWidth=1,t.globalAlpha=this.isMoving?this.borderOpacityWhenMoving:1,t.strokeStyle=t.fillStyle=this.cornerColor,this._drawControl("tl",t,c,s-r,o-r),this._drawControl("tr",t,c,s+a-r,o-r),this._drawControl("bl",t,c,s-r,o+n-r),this._drawControl("br",t,c,s+a-r,o+n-r),this.get("lockUniScaling")||(this._drawControl("mt",t,c,s+a/2-r,o-r),this._drawControl("mb",t,c,s+a/2-r,o+n-r),this._drawControl("mr",t,c,s+a-r,o+n/2-r),this._drawControl("ml",t,c,s-r,o+n/2-r)),this.hasRotatingPoint&&this._drawControl("mtr",t,c,s+a/2-r,o-this.rotatingPointOffset-r),t.restore(),this},drawBorders:function(t){if(!this.hasBorders)return this
t.save(),t.globalAlpha=this.isMoving?this.borderOpacityWhenMoving:1,t.strokeStyle=this.borderColor,t.lineWidth=1/this.borderScaleFactor
var e=this._calculateCurrentDimensions(!0),i=e.x,a=e.y
...
var e,i,a=t.x,n=t.y
for(var s in this.oCoords)if(this.isControlVisible(s)&&("mtr"!==s||this.hasRotatingPoint)&&(!this.get("lockUniScaling")||"mt"!==s&&"mr"!==s&&"mb"!==s&&"ml"!==s)&&(i=this._getImageLines(this.oCoords[s].corner),e=this._findCrossPoints({x:a,y:n},i),0!==e&&e%2===1))return this.__corner=s,s
return!1},_drawRoundControl:function(t,e,i,a,n,s,o){return!1}},extendITextPrototypeMobile={editable:!0,enterEditing:function(){return this.isEditing||!this.editable?void this.canvas.fire("text:editing:entered",{target:this}):(this.canvas&&this.exitEditingOnOthers(this.canvas),this.isEditing=!0,this.curvedText||(this.initHiddenTextarea(),this.hiddenTextarea.focus(),this._updateTextarea()),this._tick(),this.fire("editing:entered"),this.canvas?(this.canvas.renderAll(),this.canvas.fire("text:editing:entered",{target:this}),this.initMouseMoveHandler(),this):this)},_isObjectMoved:function(t){var e=this.canvas.getPointer(t)
...
switch(a){case"changeState":if(n){var s=this.getElement("currentActionInfo"),o=canvas.getActiveObject()||canvas.getActiveGroup()
s.html(translateStrings[n]),this.beforeChangeStateObserver({state:n,object:o}),this.changeState(n)}break
case"font_edit":var o=canvas.getActiveObject()||canvas.getActiveGroup()
that.runHooks("beforeChangeStateObserver",{state:n,object:o})
break
case"color_edit":var o=canvas.getActiveObject()||canvas.getActiveGroup()
that.runHooks("beforeChangeStateObserver",{state:n,object:o})
break
case"undo":undo()
break
...
s=a.find("li[data-state='"+i.getFontFamily()+"']"),a.find("a").removeClass(this.active),s.find("a").addClass(this.active)
break
...
var n=this.getElement("subItemAlign"),s=n.find("li[data-state='"+i.getTextAlign()+"']")
n.find("a").removeClass(this.active),s.find("a").addClass(this.active)
break
...
var o=this.getElement("subItemDecoration"),r=o.find("li[data-state='"+i.getFontWeight()+"']"),c=o.find("li[data-state='"+i.getFontStyle()+"']"),l=o.find("li[data-state='"+i.getTextDecoration()+"']")
o.find("a").removeClass(this.active),r.find("a").addClass(this.active),"italic"===i.getFontStyle()&&c.find("a").addClass(this.active),l.find("a").addClass(this.active)
break
...
t.each(i.shapes,function(e,a,n){return function(s,o){var r="shape_"+Math.random().toString(36).substring(5),c=t(a)
c.addClass(r),c.data("shapeUrl",shapeUrlLocation+i.category+o),c.find("a").off("click").on("click",function(e){return function(a){var n=t(a.currentTarget)
t(".shapesMobileItem").removeClass("active"),n.addClass("active")
n.data("shapeUrl")
e.clearConfirmPanelButtons()
var s=e.getElement("confirmPanelButtons")
s.data("actionsEditorOptions",{actionType:"shape",url:shapeUrlLocation+i.category+o})}}(e)),n.append(c),t("<img/>").attr("src",shapeUrlLocation+i.category+o).load(function(t,e,a){return function(){var a=e.find("li."+t)
a.removeClass("empty"),a.find("a").css({"background-image":"url("+shapeUrlLocation+i.category+o+")"}),a.removeClass(t)}}(r,n,e))}}(e,a,n)),e.lockGetShapes=!1}}}(this),onFail:function(t){return function(){alert(translateStrings.error),t.lockGetShapes=!1}}(this)})},afterSelectObject:function(t){if(t){var e=t.object.type,i=t.ppmt
...
break
default:i.changeState("general")}}},afterClearSelection:function(t){t&&t.hasOwnProperty("ppmt")&&t.ppmt.changeState("open")},connectHooks:function(){},initTextActions:function(){this._on(this.element.find(".clickTextAction"),{click:function(e){var i=t(e.currentTarget),a=i.data("action"),n=i.data("state")||!1,s=canvas.getActiveObject()
switch(a){case"changeState":if(n){var o=this.getElement("currentActionInfo")
o.html(translateStrings[n]),this.changeState(n),this.beforeChangeStateObserver({state:n,object:s}),"transparency_edit"===n&&this.setDefaultTransparency()}break
case"font":s.set("fontFamily",n)
var r=this.getElement("subItemFonts")
r.find("a").removeClass(this.active),i.find("a").addClass(this.active),canvas.renderAll()
break
case"fontsizeIncrease":var c=parseInt(s.getFontSize())
c+this.fontSizeUnit<120&&(s.set("fontSize",c+this.fontSizeUnit),canvas.renderAll())
break
case"fontsizeDecrease":var c=parseInt(s.getFontSize())
c-this.fontSizeUnit>1&&(s.set("fontSize",c-this.fontSizeUnit),canvas.renderAll())
break
...
switch(n){case"italic":s.setFontStyle("italic"),d.find("a").toggleClass(this.active),g.find("a").removeClass(this.active),canvas.renderAll()
break
case"bold":s.setFontWeight("bold"),h.find("a").toggleClass(this.active),g.find("a").removeClass(this.active),canvas.renderAll()
break
case"normal":s.setFontWeight("normal"),s.setFontStyle("normal"),s.setTextDecoration(""),l.find("a").removeClass(this.active),h.find("a").removeClass(this.active),u.find("a").removeClass(this.active),g.find("a").addClass(this.active),canvas.renderAll()
break
case"underline":s.setTextDecoration("underline"),u.find("a").toggleClass(this.active),g.find("a").removeClass(this.active),canvas.renderAll()}break
case"align":if(["left","right","center","justify"].indexOf(n)>-1){s.setTextAlign(n)
...
s.set("fill",v),s.set("fillColorId",b),m.find("a").removeClass(this.active),i.addClass(this.active),canvas.renderAll()
break
...
if(n){var s=n.type
"text"!==s&&"textbox"!==s&&"i-text"!==s||n.fire("mouseup",{e:e})}this.changeState("editText_mode",!1)
break
...
else{var o=this.previousState.pop()
this.changeState(o,!0)}break
...
this.changeState(o,!0)}}}}),canvas.on("text:editing:entered",function(t){return function(e){var i=e.target
i&&!i.curvedText&&"editText_mode"!==t.state&&t.changeState("editText_mode",!0)}}(this))},initImagesActions:function(){this._on(this.element.find(".clickImageAction"),{click:function(e){var i=t(e.currentTarget),a=i.data("action"),n=i.data("state")||!1,s=canvas.getActiveObject()
switch(a){case"changeState":if(n){var o=this.getElement("currentActionInfo")
o.html(translateStrings[n]),this.changeState(n),"effect_edit"===n&&(this.beforeChangeStateObserver({state:n,object:s}),this.populateEffects()),"transparency_edit"===n&&(this.beforeChangeStateObserver({state:n,object:s}),this.setDefaultTransparency())}break
case"duplicate":this.runHooks("cloneObject")}}})},initDefaultActions:function(){this._on(this.element.find(".clickDefaultAction"),{click:function(e){var i=t(e.currentTarget),a=i.data("action"),n=i.data("state")||!1,s=canvas.getActiveObject()
switch(a){case"changeState":if(n){var o=this.getElement("currentActionInfo")
o.html(translateStrings[n]),this.changeState(n),a="category-shape"==n&&i.data("category"),"transparency_edit"!==n&&"color_edit"!==n&&"category-shape"!==n||(this.beforeChangeStateObserver({state:n,object:s,action:a}),"transparency_edit"==n&&this.setDefaultTransparency())}break
...
break
case"add_image":var s=this.getElement("uploadTrigger")
s.trigger("click")
break
case"add_to_cart":this.runHooks("addToCart",!0)
break
case"changeText":this.changeState("text",!0)
var o=t(".fabric_edit_text").text()
canvas.getActiveObject().setText(o),canvas.renderAll(),fabric.IText.prototype.exitEditingOnOthers(canvas),t(".fabric_edit_text").remove(),canvas.fire("text:editing:exited")
break
...
if(s.html(translateStrings[n]),this.changeState(n),"layouts"===n){var o=this.getElement("layoutsContainerMobile")
o.printqPositioning()}if("shapes"===n){var r=this.getElement("shapesContainerMobile")
r.printqPositioning()}if("backgrounds"===n){var c=this.getElement("backgroundsContainerMobile")
c.printqPositioning()}}break
...
switch(a){case"changeState":if(n){var s=this.getElement("currentActionInfo")
s.html(translateStrings[n]),this.changeState(n)}break
case"change-layout":var o=this.getElement("layoutsMobileItem")
o.removeClass("active"),i.addClass("active")
var r=i.data("id")
...
t.removeData()},initFineUploader:function(){var e=this.getElement("fineuploader"),i=this.getElement("mask"),a=t.printqUniqueId({prefix:"loading_",sufix:"uploadMobileImage",length:6}),n=e.fineUploader({request:{endpoint:uploadUserPhotoUrl,params:{id:"randomid",createThumbnail:1,sid:uploadPhotoDirName,width:"auto",height:150,other_infos:{type:"editorUpload"},createWorkingImage:1,quality:90}},autoUpload:!0,debug:!1,multiple:!1,text:{uploadButton:"mobile",dragZone:"mobile"},validation:{allowedExtensions:e.attr("data-validate")?[e.attr("data-validate")]:["jpeg","jpg","png","gif"]},template:"pqd_qq_uploader",fileTemplate:"pqd_qq_uploader",showMessage:function(t){alert(t,"warning")}}).on("upload",function(e,i,a){return function(){t.q(a).prinqLoading("start",i)}}(this,a,i)).on("complete",function(e,i,a){return function(n,s,o,r){if(r.hasOwnProperty("success")&&r.success){var c,l
c=r.working_image?r.working_image:r.src,l=r.thumbnail?r.thumbnail:r.src,fabric.Image.fromURL(c,function(e,i,a,n,s){return function(o){var r=canvas.getCenter()
o.set({originX:"center",originY:"center",designerOptions:{type:"image",workingImage:c,originalWidth:e.other_infos.size.width,originalHeight:e.other_infos.size.height,actualWidth:o.width,actualHeight:o.height,imageName:e.path},thumbnail:i}),o.set({left:r.left,top:r.top}),o=a.resizeImage(o),canvas.insertAt(o,canvas.getObjects().length-canvas.helpersInCanvas,!1),a.runHooks("pushUndoData",[{objectID:o.objectID,added:o,type:"image"}]),a.runHooks("updateIframe"),t.q(s).prinqLoading("stop",n)}}(r,l,e,i,a))}else t.q(a).prinqLoading("stop",i),alert(errorMsgTxt,"error")}}(this,a,i)).on("fail",function(e,i){return function(){t.q(i).prinqLoading("stop",e)}}(a,i))
this.getElement("uploadTrigger").on("change",function(e){return function(){t(e).fineUploader("addFiles",this.files)}}(n))},resizeImage:function(t){var e=400,i=400,a=0,n=t.width,s=t.height
return n>e&&(a=e/n,t.width=e,t.height=s*a,s*=a,n*=a),s>i&&(a=i/s,t.height=i,t.width=n*a,n*=a),t},initCanvasObserver:function(){canvas.on("object:selected",function(e){return function(i){var a=i.target
...
break
case"shape":var s=a.url
this.runHooks("loadShapeMobile",s)}this.clearConfirmPanelButtons()},notConfirmChangers:function(){var e,i,a=this.getElement("confirmPanelButtons"),n=a.data("editEditorOptions"),s=a.data("actionsEditorOptions")
if(n&&(i=n.object.objectID,e=canvas.getObjectByID(i)[0],e&&n.objectOptions&&(t.each(n.objectOptions,function(t,i){e.set(t,i),"filters"===t&&e.applyFilters(function(){canvas.renderAll()})}),canvas.renderAll())),s)switch(s.actionType){case"layout":this.runHooks("makeActualLayoutSelected",parseInt(themePageContent[0].theme_id))
break
case"background":this.runHooks("makeBackgroundImageSelected")
break
case"shape":var o=this.getElement("shapesMobileItem")
o.removeClass("active")}this.clearConfirmPanelButtons()},setDefaultTransparency:function(){var t=canvas.getActiveObject()||canvas.getActiveGroup()
opacity=t.getOpacity(),this.checkSliderOpacity()&&this.sliderOpacity.slider("value",100*opacity)},checkSliderOpacity:function(){return this.sliderOpacity.length?"undefined"!=typeof this.slider.data("uiSlider")||"undefined"!=typeof this.slider.data("ui-slider")||(this.createSliderOpacity(),!0):(this.createSliderOpacity(),!0)},createSliderOpacity:function(){this.slider=this.getElement("sliderOpacity",!0),this.slider.slider({slide:function(e){return function(e,i){t(this).data("ui-slider")
canvas.getActiveGroup()&&canvas.getActiveGroup().setOpacity(i.value/100),canvas.getActiveObject()&&canvas.getActiveObject().setOpacity(i.value/100),canvas.renderAll()}}(this)})},populateEffects:function(){var e,i=canvas.getActiveObject(),a=new Image,n=document.createElement("canvas"),s=n.getContext("2d"),o=this.getElement("effectToolBarMobile")
i&&"image"==i.type&&(o.find("ul").html(""),a.onload=function(o){return function(){n.width=.5*a.naturalWidth,n.height=.5*a.naturalHeight,t.each(o._O("effectsList"),function(o){return function(r,c){s.clearRect(0,0,n.width,n.height),s.drawImage(a,0,0,n.width,n.height)
var l=s.getImageData(0,0,n.width,n.height)
"Emboss"==c||"Sharpen"==c||"Blur"==c?(l.filterName=c,e=t.printqFiltersFunctions.Convolute(l)):e="function"==typeof t.printqFiltersFunctions[c]?t.printqFiltersFunctions[c](l):l,s.putImageData(e,0,0),o.createEffectElement({effectName:c,image:n.toDataURL(),block:i})}}(o))}}(this),a.src=i._originalElement.src)},createEffectElement:function(e){var i=this.getElement("effectToolBarMobile"),a=this.effectItemTemplate
